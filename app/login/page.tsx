  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#0a0b0e] px-4">
      <div className="w-full max-w-sm">
        <form onSubmit={handleLogin} className="rounded-[8px] border border-[#1c1e24] bg-[#0d0f12] p-8">
        ...
        <p className="mt-6 text-center text-[13px] text-[#6b7280]">
          ...
          <Link href="/signup" className="text-[#e8eaf0] transition-colors hover:text-[#4fffb0]">
            Create one
          </Link>
        </p>
      </div>
